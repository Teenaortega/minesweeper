...
function Board() {
    ...
    const revealcell=(x,y)=>{
        ...
        if(newGrid[x][y].value==="X"){
            toast.error(`Opps! That's a mine. Try again!`, { position: "top-center", autoClose: 1000, hideProgressBar: false, closeOnClick: true, pauseOnHover: true, draggable: true, progress: undefined, theme: "dark" });
    ...
    return (
        <div className="parent">
            <div>
                <h3 style={{color:'white',textAlign:'center',fontSize:'30px',margin:'0px'}}>Coal - {nonMinecount}</h3>
